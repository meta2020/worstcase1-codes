...
datafile = "C:\Users\zhouy\Documents\GitHub-Bios\worstcase1-codes\Example2\anadata\eg2-IVD-cc.csv"
dbms = csv replace;
getnames = yes;
run;
proc import out=par_all_wide 
datafile = "C:\Users\zhouy\Documents\GitHub-Bios\worstcase1-codes\Example2\anadata\ml-par-IVD.csv"
dbms = csv replace;
getnames = yes;
run;
...
ods html;
%include "C:\Users\zhouy\Documents\GitHub-Bios\worstcase1-codes\Example2\macro_bias2.sas";
...
proc export data=result
    outfile="C:\Users\zhouy\Documents\GitHub-Bios\worstcase1-codes\Example2\SAS\result2-2000IVD.csv"
    dbms=csv replace;
run;
...
proc export data=result
    outfile="C:\Users\zhouy\Documents\GitHub-Bios\worstcase1-codes\Example2\SAS\result2-1000IVD.csv"
    dbms=csv replace;
run;
...
proc export data=result
    outfile="C:\Users\zhouy\Documents\GitHub-Bios\worstcase1-codes\Example2\SAS\result2-20000IVD.csv"
    dbms=csv replace;
run;

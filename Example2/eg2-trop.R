...
write.csv(par, "ml-par-trop.csv", row.names = F)


sa.fit1 <- dtametasa.fc(example2.1, p = 1)
sa.fit1$sauc.ci
...
## WORST-CASE BOUNDS UNDER CONDITION D4.1-D4.3, REPEAT 10 TIMES, PRODUCED BY SAS
## WHEN c = (1, 0)
y1d1.dat <- read.csv("SASresult/trop/result2-R10-K2000-c1-as1.csv")
y1d2.dat <- read.csv("SASresult/trop/result2-R10-K2000-c1-as2.csv")
y1d3.dat <- read.csv("SASresult/trop/result2-R10-K2000-c1-as3.csv")
## WHEN c = (0, 1)
y2d1.dat <- read.csv("SASresult/trop/result2-R10-K2000-c2-as1.csv")
y2d2.dat <- read.csv("SASresult/trop/result2-R10-K2000-c2-as2.csv")
y2d3.dat <- read.csv("SASresult/trop/result2-R10-K2000-c2-as3.csv")
## WHEN tilde c IS USED
y3d1.dat <- read.csv("SASresult/trop/result2-R10-K2000-c3-as1.csv")
y3d2.dat <- read.csv("SASresult/trop/result2-R10-K2000-c3-as2.csv")
y3d3.dat <- read.csv("SASresult/trop/result2-R10-K2000-c3-as3.csv")
...
ggsave(filename = "eg2-1.eps", plot = p11, device = cairo_ps, width = 12, height = 12)
...
ggsave(filename = "eg2-2.eps", plot = p21, device = cairo_ps, width = 12, height = 12)

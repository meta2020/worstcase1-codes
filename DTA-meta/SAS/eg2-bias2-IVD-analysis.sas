...
/*CREATE LOG FILE*/
proc printto log = "C:\Users\zhouy\Documents\GitHub-Bios\worstcase1-codes\DTA-meta\SAS\ivd\log-ivd.txt"; run;
...
%let kk = 1000; 
ods html file="IVDresult2-K&kk.-R&rr..html" path="C:\Users\zhouy\Documents\GitHub-Bios\worstcase1-codes\DTA-meta\SAS\ivd\";
...
proc export data=result
    outfile="C:\Users\zhouy\Documents\GitHub-Bios\worstcase1-codes\DTA-meta\SAS\ivd\IVDresult2-K&kk.-R&rr..csv"
    dbms=csv replace;
run;

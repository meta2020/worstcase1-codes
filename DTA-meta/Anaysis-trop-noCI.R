...
ggsave(filename = "fig-tab/trop/eg2-trop.eps", plot = p1, device = cairo_ps, width = 12, height = 12)
...
kbl(tab11,
    ...
    align = "r",
    escape = FALSE,
    caption = "Example 1: the lower bound of the SAUC by the simulation-based bound.",
    label = "tab2-trop",
    row.names = NA)%>%
...
ggsave(filename = "fig-tab/trop/eg2-comp-trop.eps", plot = p24, device = cairo_ps, width = 12, height = 12)
